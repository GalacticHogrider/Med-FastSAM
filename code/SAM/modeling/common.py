...
class LowLevelFeatureExtractorMixed(nn.Module):
    def __init__(self):
        super(LowLevelFeatureExtractorMixed, self).__init__()
        self.features1 = nn.Sequential(nn.Conv2d(3, 32, kernel_size=4, stride=4),
                            LayerNorm2d(32),
                            nn.GELU())
...
class LowLevelFeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            ...
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=4, stride=4),  # 1024 -> 256
